...
def european_call(r, sigma, T, Bu, m, n, Bl=0.0, barrier=None, method=None, isAmerican=False):
    ...
    bss = BlackScholesSolver(r, sigma, T, Bl, Bu, Fl, Fu, Fp, m, n, isAmerican)
    return X, bss.solve(method)


def european_put(r, sigma, T, Bu, m, n, Bl=0.0, barrier=None, method=None, isAmerican=False):
